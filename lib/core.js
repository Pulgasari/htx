...
// Also exported for alternative engines (e.g. lib2's web-component runtime)
// that reuse this tree/expand/serialize machinery with their own def-tag
// vocabulary and their own preprocessing pass.
export       { compile, parse, serialize, expand, getAttr };
