// meta.js — tag metadata for the htx runtime
...
// Tags whose content is opaque text, not nested markup (mirrors the HTML
// spec's "raw text element" rule) — the tree parser must not tag-scan inside
// these, otherwise a `<` in a script/style body would derail it.
